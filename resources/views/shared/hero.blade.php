                        ...
                        <div class="col-lg-6">
                            <div class="slide-item-content">
                                ...
                                <div class="slide-item-btn">
                                    <a href="{{ route('collection.list') }}" class="primary-btn-xl">Shop Now</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 d-flex justify-content-lg-end">
                            <div class="slide-item-figure">
                                <img src="{{ asset('assets/images/banner/slider-5.png') }}" alt=""
                                    class="img-fluid figure">

                                <div class="figure-shape">
                                    <img src="{{ asset('assets/images/shape/slider-5.png') }}" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="swiper-slide hero-slide-item">
                <div class="container">
                    <div class="row d-flex align-items-center">
                        ...
                        <div class="col-lg-6 d-flex justify-content-lg-end">
                            <div class="slide-item-figure">
                                <img src="{{ asset('assets/images/banner/slider-2.png') }}" alt=""
                                    class="img-fluid figure">

                                <div class="figure-shape">
                                    <img src="{{ asset('assets/images/shape/slider-2.png') }}" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
