        ...
        <div class="row align-items-center justify-content-between">
            <div class="col-auto">
                <div class="header-logo">
                    <a href="index.html">
                        <img class="logo-main" src="{{ asset('assets/theme/images/logo.png') }}" width="153" height="30" alt="Logo">
                    </a>
                </div>
            </div>
            <div class="col-auto d-none d-lg-block">
                <div class="header-navigation">
                    <ul class="main-nav">
                        ...
                        <li class="has-submenu position-static"><a href="/about-us">About Us</a>
            ...
            <div class="col-auto">
                <div class="header-action">
                    ...
                    <button class="header-action-cart" type="button" data-bs-toggle="offcanvas"
                        data-bs-target="#offcanvasWithCartSidebar" aria-controls="offcanvasWithCartSidebar"> 02 Items
