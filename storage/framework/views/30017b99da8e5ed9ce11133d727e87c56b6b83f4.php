...
<main class="main-content">
    ...
    <section class="hero-two-slider-area position-relative">
        <div class="swiper hero-two-slider-container">
            <div class="swiper-wrapper">
                <div class="swiper-slide hero-two-slide-item bg-img" data-bg-img="<?php echo e(asset('assets/theme/images/slider/slider1-bg1.jpg')); ?>">
                    <div class="container">
                        <div class="hero-two-slide-content mousemove">
                            <!-- <img class="hero-two-slide-shape-img" src="<?php echo e(asset('assets/theme/images/slider/shape-polygon1.png')); ?>"
                ...
                <div class="swiper-slide hero-two-slide-item bg-img" data-bg-img="<?php echo e(asset('assets/theme/images/slider/slider2-bg1.jpg')); ?>">
                    <div class="container">
                        <div class="hero-three-slide-content mousemove">
                            <img class="hero-three-slide-shape-img" src="<?php echo e(asset('assets/theme/images/slider/shape-polygon1.png')); ?>"
                                width="657" height="568" alt="Image">
                            ...
                            <img class="hero-three-slide-product-img" src="<?php echo e(asset('assets/theme/images/slider/slider2-product1.png')); ?>"
        ...
        <div class="container">
            ...
            <div class="row mb-n6">
                <div class="col-sm-6 col-lg-4 mb-6">
                    ...
                    <div class="product-item">
                        <a class="product-thumb" href="shop-single-product.html">
                            <img src="<?php echo e(asset('assets/theme/images/shop/10.jpg')); ?>" width="300" height="286" alt="Image-HasTech">
                        </a>
                ...
                <div class="col-sm-6 col-lg-4 mb-6">
                    ...
                    <div class="product-item">
                        <a class="product-thumb" href="shop-single-product.html">
                            <img src="<?php echo e(asset('assets/theme/images/shop/11.jpg')); ?>" width="300" height="286" alt="Image-HasTech">
                        </a>
                        <span class="badges">New</span>
                        <div class="product-action">
                            <button type="button" class="product-action-btn action-btn-quick-view"
                ...
                <div class="col-sm-6 col-lg-4 mb-6">
                    ...
                    <div class="product-item">
                        <a class="product-thumb" href="shop-single-product.html">
                            <img src="<?php echo e(asset('assets/theme/images/shop/12.jpg')); ?>" width="300" height="286" alt="Image-HasTech">
                        </a>
                        <span class="badges">New</span>
                        <div class="product-action">
                            <button type="button" class="product-action-btn action-btn-quick-view"
        ...
        <div class="container">
            ...
            <div class="row mb-n6">
                <div class="col-sm-6 col-lg-4 mb-6">
                    ...
                    <div class="product-item">
                        <a class="product-thumb" href="shop-single-product.html">
                            <img src="<?php echo e(asset('assets/theme/images/shop/13.png')); ?>" width="300" height="286" alt="Image-HasTech">
                        </a>
                        <span class="badges">New</span>
                        <div class="product-action">
                            <button type="button" class="product-action-btn action-btn-quick-view"
                ...
                <div class="col-sm-6 col-lg-4 mb-6">
                    ...
                    <div class="product-item">
                        <a class="product-thumb" href="shop-single-product.html">
                            <img src="<?php echo e(asset('assets/theme/images/shop/14.jpg')); ?>" width="300" height="286" alt="Image-HasTech">
                        </a>
                        <span class="badges">New</span>
                        <div class="product-action">
                            <button type="button" class="product-action-btn action-btn-quick-view"
                ...
                <div class="col-sm-6 col-lg-4 mb-6">
                    ...
                    <div class="product-item">
                        <a class="product-thumb" href="shop-single-product.html">
                            <img src="<?php echo e(asset('assets/theme/images/shop/15.jpg')); ?>" width="300" height="286" alt="Image-HasTech">
                        </a>
                        <span class="badges">New</span>
                        <div class="product-action">
                            <button type="button" class="product-action-btn action-btn-quick-view"
                ...
                <div class="col-sm-6 col-lg-4 mb-6">
                    ...
                    <div class="product-item">
                        <a class="product-thumb" href="shop-single-product.html">
                            <img src="<?php echo e(asset('assets/theme/images/shop/16.jpg')); ?>" width="300" height="286" alt="Image-HasTech">
                        </a>
                        <span class="badges">New</span>
                        <div class="product-action">
                            <button type="button" class="product-action-btn action-btn-quick-view"
                ...
                <div class="col-sm-6 col-lg-4 mb-6">
                    ...
                    <div class="product-item">
                        <a class="product-thumb" href="shop-single-product.html">
                            <img src="<?php echo e(asset('assets/theme/images/shop/17.jpg')); ?>" width="300" height="286" alt="Image-HasTech">
                        </a>
                        <span class="badges">New</span>
                        <div class="product-action">
                            <button type="button" class="product-action-btn action-btn-quick-view"
                ...
                <div class="col-sm-6 col-lg-4 mb-6">
                    ...
                    <div class="product-item">
                        <a class="product-thumb" href="shop-single-product.html">
                            <img src="<?php echo e(asset('assets/theme/images/shop/18.jpg')); ?>" width="300" height="286" alt="Image-HasTech">
                        </a>
                        <span class="badges">New</span>
                        <div class="product-action">
                            <button type="button" class="product-action-btn action-btn-quick-view"
        ...
        <div class="container">
            ...
            <div class="row mb-n8">
                <div class="col-sm-6 col-md-4 mb-8">
                    ...
                    <a class="product-category-item" href="shop.html">
                        <div class="product-category-thumb">
                            <img src="<?php echo e(asset('assets/theme/images/shop/category/01.png')); ?>" width="326" height="385" alt="Image-HasTech">
                        </div>
                ...
                <div class="col-sm-6 col-md-4 mb-8">
                    ...
                    <a class="product-category-item" href="shop.html">
                        <div class="product-category-thumb">
                            <img src="<?php echo e(asset('assets/theme/images/shop/category/02.png')); ?>" width="326" height="385" alt="Image-HasTech">
                        </div>
                ...
                <div class="col-sm-6 col-md-4 mb-8">
                    ...
                    <a class="product-category-item" href="shop.html">
                        <div class="product-category-thumb">
                            <img src="<?php echo e(asset('assets/theme/images/shop/category/03.png')); ?>" width="326" height="385" alt="Image-HasTech">
                        </div>
        ...
        <div class="container">
            ...
            <div class="row mb-n8">
                <div class="col-sm-12 col-md-6 mb-8">
                    ...
                    <div class="post-item">
                        <a href="blog-details.html" class="thumb">
                            <img class="w-100" src="<?php echo e(asset('assets/theme/images/blog/1.png')); ?>" width="570" height="320"
                                alt="Image-HasTech">
                        </a>
                        <div class="content">
                ...
                <div class="col-sm-12 col-md-6 mb-8">
                    ...
                    <div class="post-item">
                        <a href="blog-details.html" class="thumb">
                            <img class="w-100" src="<?php echo e(asset('assets/theme/images/blog/2.png')); ?>" width="570" height="320"
                                alt="Image-HasTech">
                        </a>
                        <div class="content">
                            <a class="post-category" href="blog.html">Fashion</a>
    ...
    <section class="news-letter-area section-bottom-space">
        <div class="container">
            <div class="newsletter-content-wrap" data-bg-img="<?php echo e(asset('assets/theme/images/photos/bg1.jpg')); ?>">
...
<?php echo $__env->make('layouts.theme', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\work\tallnpreety\resources\views/pages/frontend/index.blade.php ENDPATH**/ ?>