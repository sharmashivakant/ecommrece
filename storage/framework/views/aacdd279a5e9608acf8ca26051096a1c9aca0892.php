        ...
        <ul class="navbar-nav flex-fill w-100 mb-2">
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="collapse list-unstyled pl-4 w-100" id="catalogue-elements">
                    <li class="nav-item">
                        <a class="nav-link pl-3" href="<?php echo e(route('admin.catalog.create')); ?>"><span class="ml-1 item-text">Create New</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link pl-3" href="<?php echo e(route('admin.catalog.index')); ?>"><span class="ml-1 item-text">Manage Catalogue</span></a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="collapse list-unstyled pl-4 w-100" id="orders-elements">
                    <li class="nav-item">
                        <a class="nav-link pl-3" href="<?php echo e(route('admin.orders.index')); ?>"><span
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="collapse list-unstyled pl-4 w-100" id="pay-elements">
                    <li class="nav-item">
                        <a class="nav-link pl-3" href="<?php echo e(route('admin.payments.index')); ?>"><span
                                class="ml-1 item-text">Manage</span></a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="collapse list-unstyled pl-4 w-100" id="users-elements">
                    <li class="nav-item">
                        <a class="nav-link pl-3" href="<?php echo e(route('admin.customer.index')); ?>"><span
                                class="ml-1 item-text">Manage</span></a>
                    </li>
                </ul>
            </li>
...
<?php /**PATH D:\work\tallnpreety\resources\views/shared/backend/sidebar.blade.php ENDPATH**/ ?>