...
<aside class="sidebar-cart-modal offcanvas offcanvas-end" data-bs-scroll="true" tabindex="-1" id="offcanvasWithCartSidebar">
                        ...
                        <div class="cart-content cart-content-padding">
                            <ul>
                                <li class="single-product-cart">
                                    <div class="cart-img">
                                        <a href="shop-single-product.html"><img src="<?php echo e(asset('assets/theme/images/shop/s1.jpg')); ?>" alt="Image" width="70" height="67"></a>
                                    </div>
                                ...
                                <li class="single-product-cart">
                                    <div class="cart-img">
                                        <a href="shop-single-product.html"><img src="<?php echo e(asset('assets/theme/images/shop/s2.jpg')); ?>" alt="Image" width="70" height="67"></a>
                                    </div>
                                    <div class="cart-title">
        ...
        <!--== End Sidebar Cart Menu ==--><?php /**PATH D:\work\tallnpreety\resources\views/shared/theme/sidecart.blade.php ENDPATH**/ ?>