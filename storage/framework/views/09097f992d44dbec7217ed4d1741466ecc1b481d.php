...
} elseif ($_instance->childHasBeenRendered('naPiEg5')) {
    $componentId = $_instance->getRenderedChildComponentId('naPiEg5');
    $componentTag = $_instance->getRenderedChildComponentTagName('naPiEg5');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('naPiEg5');
} else {
    $response = \Livewire\Livewire::mount('cart.add',['pid' => $product->id ]);
    $html = $response->html();
    $_instance->logRenderedChild('naPiEg5', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                            </div>
...
<?php echo $__env->make('layouts.web', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\work\tallnpreety\resources\views/pages/frontend/home.blade.php ENDPATH**/ ?>