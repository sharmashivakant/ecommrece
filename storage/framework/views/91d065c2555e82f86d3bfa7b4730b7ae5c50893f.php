...
} elseif ($_instance->childHasBeenRendered('R5J126F')) {
    $componentId = $_instance->getRenderedChildComponentId('R5J126F');
    $componentTag = $_instance->getRenderedChildComponentTagName('R5J126F');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('R5J126F');
} else {
    $response = \Livewire\Livewire::mount('cart.count');
    $html = $response->html();
    $_instance->logRenderedChild('R5J126F', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?></div>
                                </li>
...
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('cart.count')->html();
} elseif ($_instance->childHasBeenRendered('vD8TFTY')) {
    $componentId = $_instance->getRenderedChildComponentId('vD8TFTY');
    $componentTag = $_instance->getRenderedChildComponentTagName('vD8TFTY');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('vD8TFTY');
} else {
    $response = \Livewire\Livewire::mount('cart.count');
    $html = $response->html();
    $_instance->logRenderedChild('vD8TFTY', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?></div>
                            </li>
...
<!-- ===============  header area end =============== -->
<?php /**PATH C:\xampp\htdocs\tallnpreety\resources\views/shared/header.blade.php ENDPATH**/ ?>