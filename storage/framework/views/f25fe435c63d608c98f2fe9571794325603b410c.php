                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="eg-input-group">
                                    ...
                                    <input type="text" id="first-name1" name="address[first_name]"
                                        value="<?php echo e(ucwords($profile->first_name ?? null)); ?>" placeholder="Your first name">
                                </div>
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="eg-input-group">
                                    ...
                                    <input type="text" id="last-name" name="address[last_name]"
                                        value="<?php echo e(ucwords($profile->last_name ?? null)); ?>" placeholder="Your last name">
                                </div>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-lg-12">
                                <div class="eg-input-group">
                                    ...
                                    <input type="text" name="address[address]"  value="<?php echo e(ucwords($profile->address ?? null)); ?>"
...
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                    <span class="text-danger"><?php echo e('Address is required'); ?></span>
                                <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
...
unset($__errorArgs, $__bag); ?>
                                <div class="eg-input-group">
                                    <input type="text" name="address[pincode]" value="<?php echo e($profile->pincode ?? null); ?>"
                                        placeholder="Post Code">
                                </div>
                                <?php $__errorArgs = ['address.pincode'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                    <span class="text-danger"><?php echo e('Pincode is required'); ?></span>
                                <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-lg-12">
                                <div class="eg-input-group">
                                    ...
                                    <input type="text" name="address[phone]" value="<?php echo e($profile->phone ?? null); ?>"
                                        placeholder="Your Phone Number">
                                </div>
                                <?php $__errorArgs = ['address.phone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                    <span class="text-danger"><?php echo e('Phone is required'); ?></span>
                                <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                                <div class="eg-input-group">
                                    <input type="text" value="<?php echo e(ucwords($profile->user->email ?? null)); ?>" readonly
                                    ...
                                    <?php $__currentLoopData = ShoppingCart::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li class="single-product">
                                            <div class="product-img">
                                                <img src="<?php echo e(asset('uploads/product/images/' . $item->product->picture[0])); ?>"
                                                    alt="">
                                            </div>
...
<?php echo $__env->make('layouts.web', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tallnpreety\resources\views/pages/frontend/checkout.blade.php ENDPATH**/ ?>